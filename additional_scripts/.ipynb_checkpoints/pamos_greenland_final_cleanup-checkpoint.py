...
data = xr.open_dataset("20240724_20240807_msfridtjofnansen_pamos.nc")

# Add GPS data from the ship as reference
files = sorted(glob.glob("nansen_greenland/*.nrt"))
...
data.to_netcdf("20240724_20240807_msfridtjofnansen_pamos_shipposition.nc")

# Export additional csv file for Pangaea
ds = xr.open_dataset("20240724_20240807_msfridtjofnansen_pamos_shipposition.nc")
df = ds.to_dataframe()
...
df.to_csv("20240724_20240807_msfridtjofnansen_pamos_shipposition.csv", sep = ';', header = True)